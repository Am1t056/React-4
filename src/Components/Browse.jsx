        ...
        <div className="row flex justify-center">
            <div className="col-lg-7">
                     <div className='section-title text-center py-3'>
                        ...
                        <a className='btn btn-primary hover:translate-y-[-6px] ease-in hover:bg-[#766df7] mt-4 duration-1000 mb-2' href="">Started Now<i className="fa-solid fa-rocket ms-1"></i></a>
                    </div>
            </div>
        </div>
    </div>
