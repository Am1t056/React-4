    ...
    <div className='container'>
        <div className="row flex justify-center">
            <div className="col-lg-7">
                    ...
                    <a href="" className="p-2 rounded-md no-underline bg-[#766df4] hover:bg-[#766df9] hover:text-[#fff] text-[#ffffff]">Started Now<i className="fa-solid fa-arrow-right ms-1 text-[12px]"></i></a>
                    </div>
