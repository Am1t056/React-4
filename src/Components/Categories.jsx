        ...
        <div className="container">
          ...
          <div className="row mb-5">
                <div className="col-lg-12 ">
                    ...
                    <a href="" className="p-2 rounded-md no-underline  bg-[#766df4] hover:bg-[#766df9] hover:text-[#fff] text-[#ffffff]">Browse All Categories<i className="fa-solid fa-arrow-right ms-1 text-[12px]"></i></a>
                    </div>
                </div>
            </div>
