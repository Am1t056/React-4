           ...
           <div className="container">
            <div className="row flex justify-between items-center">
                <div className="col-lg-7">
                                     <div className="mb-0 pb-3 me-lg-5 py-5 px-0">
                                        <h6 className="sub-title text-[14px] text-[#495057] uppercase font-[600]">We have 150,000+ live jobs</h6>
                                        <h1 className="display-5 fw-semibold mb-3 text-[38px] lg:text-[48px] w-full lg:w-[70%] text-[#495057] py-1">Thousand of Jobs is Waiting for you</h1>
                                        <p className="w-full md:w-[75%] mb-0 text-[18px] text-[#74788d]">Find jobs, create trackable resumes and enrich your applications.Carefully crafted after analyzing the needs of different industries.</p>
                                    </div>
                                    <form action="#">
                                        <div className="registration-form" >
                                            <div className="grid-cols-3 lg:grid  gap-0">
                                                ...
                                                <div className="lg:px-0 mt-2 md:mt-0 h-[48px] ">
                                                     <i className="fa-solid fa-location-dot absolute z-20 text-[#776df4] mt-3 ml-2"></i>
                                                ...
                                                <i className="fa-solid fa-search absolute z-20 text-white mt-3 ml-2 lg:ml-16 "></i>
