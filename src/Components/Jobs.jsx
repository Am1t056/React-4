        ...
        <div className='container'>
            <div className="row flex justify-center">
                <div className="col-lg-6">
                         ...
                         <h4 className='title text-[#495057] text-[30px] mt-8 font-medium'>New &amp; Random Jobs</h4>
...
<div className={`tab-pane fade ${activeTab === 'recent-jobs' ? 'show active' : ''}`} id="recent-jobs" role="tabpanel"aria-labelledby="recent-jobs-tab">
{datas.map((a)=>(
<div className="job-box card mt-4">
 ...
 <div className="p-4 ">
     ...
     <div className="col-md-2">
         ...
         <a href=""><img src={a.image} alt className="img-fluid rounded-3" /></a>
         </div>
     </div>
     {/*end col*/}
     <div className="col-md-3">
         <div className="mb-2 mb-md-0">
         <h5 className="fs-18 mb-1"><a href="" className="text-dark font-bold">{a.job}</a>
         </h5>
     ...
     <div className="col-md-2">
         <div>
         <p className="text-muted mb-2"><span className="text-[#766df4]">$</span>{a.price}</p>
         </div>
     </div>
     {/*end col*/}
     <div className="col-md-2">
         ...
         {Object.keys(a)
              ...
              .map((key, index) => (
                <span key={index} className={`badge ${getBadgeColor(a[key])} fs-13 mt-1`}>
                  {a[key]}
                </span>
              ))}
         </div>
 ...
 <div className="p-3 bg-light">
     ...
     <div className="col-md-4">
         <div>
         <p className="text-muted mb-0"><span className="text-dark">Experience :</span> {a.experience}</p>
         </div>
     </div>
     {/*end col*/}
     ...
     <div className="col-lg-2 col-md-3">
         ...
         <a href="#applyNow" data-bs-toggle="modal" className="primary-link">Apply Now <i className="fa-solid fa-angles-right" /></a>
         </div>
     </div>
     {/*end col*/}
     </div>
 ...
 <a href="" className="btn btn-primary text-white">View More<i className="fa-solid fa-arrow-right text-white text-[12px] px-1"></i></a>
         ...
         {/*end recent-jobs-tab*/}
            <div className="tab-pane fade" id="featured-jobs" role="tabpanel" aria-labelledby="featured-jobs-tab">
                {datad.map((a)=>(
